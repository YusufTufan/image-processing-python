# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 00:29:53 2024
...
# cv2.getTickCount() fonksiyonu, bilgisayarın çalışma süresini ölçen bir fonksiyondur. 
# Bu fonksiyon, belirli bir olayın gerçekleştiği zamandan başlangıç zamanını alır. 
# Bu zaman, bilgisayarın çalışma süresini saniye cinsinden temsil eder.
