# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 07:41:34 2024
...
# Erozyon işlemi
erosion1 = cv2.erode(img1, kernel, iterations=2)
erosion2 = cv2.erode(img2, kernel, iterations=2)
erosion3 = cv2.erode(img3, kernel, iterations=2)
