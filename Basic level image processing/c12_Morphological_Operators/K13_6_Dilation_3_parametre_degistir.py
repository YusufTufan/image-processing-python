# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 07:50:51 2024
...
# Dilate işlemi
dilate1 = cv2.dilate(img1, kernel, iterations=2)
dilate2 = cv2.dilate(img2, kernel, iterations=2)
dilate3 = cv2.dilate(img3, kernel, iterations=2)
