...
# Eşikleme işlemi uygula (cv2.THRESH_TOZERO_INV)
# Piksel değerleri eşik değerinden küçükse, değerleri 0 olarak ayarlar, aksi halde orijinal değeri korur.
ret1, thresh1 = cv2.threshold(img, 150, 255, cv2.THRESH_TOZERO_INV)
